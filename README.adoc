...
==== Extensions
* installation via File menu
* for example
** https://github.com/kubecost/kubecost-lens-extension[kubecost]
** https://github.com/chenhunghan/lens-ext-invaders[space invaders to destroy pods]
** https://github.com/nevalla/lens-resource-map-extension[resource map]
